...
const LandingPage = () => {
  ...
  return (
    <div className="bg-gray-100 text-gray-900">
      ...
      <Link to="/order" onClick={handleShowMenu} className="bg-yellow-500 text-gray-800 px-6 py-3 rounded hover:bg-yellow-600">
        Haz tu Pedido
      </Link>

      {/* Mostrar el menú cuando showMenu sea true */}
      {showMenu && (
        <div className="mt-8 p-4">
          <MenuList /> {/* Renderiza la lista de menús */}
        </div>
      )}
        </div>
      </section>
